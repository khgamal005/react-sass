...
export const about = [
  {
    ...
    review: [
      ...
      {
        id: 2,
        desc: "They'll have to make the best of things its an uphill climb.They'll have to make the best of things its an uphill climb.",
        name: "Gork Coder",
        link: "insta.com",
      ...
      {
        id: 3,
        desc: "They'll have to make the best of things its an uphill climb.loaded up the truck and moved to Beverly..",
        name: "Edward Johnson",
        link: "face.com",
